        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalProfessors = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AverageQuality = table.Column<double>(type: "double precision", nullable: false),
                    AverageDifficulty = table.Column<double>(type: "double precision", nullable: false),
                    WouldTakeAgainPercent = table.Column<int>(type: "integer", nullable: false),
                    TotalReviews = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WouldTakeAgain = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Professors_FirstName_LastName_UniversityId_DepartmentId",
                table: "Professors",
                columns: new[] { "FirstName", "LastName", "UniversityId", "DepartmentId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_ProfessorId_UserId",
                table: "Reviews",
                columns: new[] { "ProfessorId", "UserId" });
